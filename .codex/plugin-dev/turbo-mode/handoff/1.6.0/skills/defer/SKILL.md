...
```bash
echo '<candidates_json>' | python ../../scripts/defer.py --tickets-dir "<project_root>/docs/tickets"
```
...
python3 ../../../../ticket/1.4.0/scripts/ticket_engine_user.py ingest /tmp/ingest_payload.json
```
