# Sora Promptify — A/B Prompts

Source: `evals/sora_promptify/variants_ab.jsonl`
...
- Camera movement: handheld but steady; no whip pans
- Depth of field: natural shallow depth of field on faces in medium-close
...
Lighting + palette:
- Lighting recipe: motivated practicals; soft fill; avoid harsh flicker
...
Audio intent:
- Ambience + key sounds: room tone / street ambience; subtle cloth movement; footsteps; realistic mic perspective
