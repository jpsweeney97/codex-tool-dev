...
This directory is the source package for the Ticket plugin. Installed cache content under `~/.codex/plugins/cache/turbo-mode/ticket/1.4.0/` is a separate runtime artifact and may diverge until a deliberate refresh step is run.
...
cd /Users/jp/Projects/active/codex-tool-dev/plugins/turbo-mode/ticket/1.4.0 && uv run pytest

# From repo root
uv run pytest plugins/turbo-mode/ticket/1.4.0/tests
