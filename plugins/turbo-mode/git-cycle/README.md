...
- `pr-description` — author a reviewer-oriented PR title and body from the diff, the intent, and the
  real verification record; open or update the PR only on explicit authority.
