...
class TestExtractFencedYaml:
    def test_minimal_ticket(self) -> None:
        from turbo_mode_handoff_runtime.ticket_parsing import extract_fenced_yaml
...
class TestParseYamlFrontmatter:
    def test_minimal_fields(self) -> None:
        from turbo_mode_handoff_runtime.ticket_parsing import parse_yaml_frontmatter
...
class TestValidateSchema:
    def test_valid_minimal(self) -> None:
        from turbo_mode_handoff_runtime.ticket_parsing import validate_schema
...
class TestParseTicket:
    def test_parse_minimal_ticket(self, tmp_path: Path) -> None:
        from turbo_mode_handoff_runtime.ticket_parsing import TicketFile, parse_ticket
